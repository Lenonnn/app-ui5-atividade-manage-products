sap.ui.define([
	...
	return Opa5.extend("App2_OpenSAP.ManageProducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["App2_OpenSAP/ManageProducts/localService/mockserver"], function (mockserver) {
