sap.ui.define([
	"sap/ui/test/Opa5",
	"App2_OpenSAP/ManageProducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("App2_OpenSAP.ManageProducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "App2_OpenSAP.ManageProducts",
					async: true
				},
				hash: oOptions.hash,
